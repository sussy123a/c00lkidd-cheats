...
forcet.MouseButton1Down:connect(function()
	local placeID = script.Parent.Parent.Parent.Parent.Settings.Page1["Place ID"].Value.Value
...
f.TextColor3 = Color3.new(bgc.TextBox1.Text/255,bgc.TextBox2.Text/255,bgc.TextBox3.Text/255)
...
walkspeed.MouseButton1Down:connect(function()
	game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = walkspeeda.TextBox.Text
end)
...
leadera.MouseButton1Down:connect(function()
	while true do
wait(.1)
game.Players.LocalPlayer.leaderstats:FindFirstChild(lsn.TextBox.Text).Value = game.Players.LocalPlayer.leaderstats:FindFirstChild(lsn.TextBox.Text).Value+game.Players.LocalPlayer.leaderstats:FindFirstChild(lsa.TextBox.Text)	
end
end)
leaderc.MouseButton1Down:connect(function()
game.Players.LocalPlayer.leaderstats:FindFirstChild(lsn.TextBox.Text).Value = game.Players.LocalPlayer.leaderstats:FindFirstChild(lsa.TextBox.Value)	
end)
